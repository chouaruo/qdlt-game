...
3. effects.money 是百分比变化（整数），正数=盈利，负数=亏损。范围 -50 到 100（即 -50%跌 到 +100%翻倍）。mind/know 在 -20 到 20，luck 在 -15 到 15。【严禁】story 中不要写任何具体金额数字（不要写"赚了X万""亏了X块""投入X万USDT"），只用模糊表述如"浮盈不少""亏了一大笔""账户缩水严重""翻了一倍"等。具体盈亏由 effects.money 百分比决定，剧情不要自己编数字。
