...
3. effects.money 是百分比变化（整数），正数=盈利，负数=亏损。范围 -50 到 100（即 -50%跌 到 +100%翻倍）。mind/know 在 -20 到 20，luck 在 -15 到 15。story 中涉及金额时用占位符：{TOTAL}表示当前总资产，{CHANGE}表示本回合变化金额，{AFTER}表示变化后总资产。前端会自动替换为真实数字。例如写"账户从{TOTAL}涨到了{AFTER}"或"浮亏{CHANGE}"。不要自己编造任何具体金额数字。
